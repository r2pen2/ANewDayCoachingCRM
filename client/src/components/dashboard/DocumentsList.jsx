...
const DocumentCard = ({d}) => {
  ...
  const DocSvg = () => {
    ...
    if (d.type === DocumentType.PRESENTATION) { return <svg focusable="false" height="24" viewBox="0 0 24 24" width="24" className="SzUuf vf9sSe NMm5M"><path d="M0 0h24v24H0z" fill="none"></path><path fill={fill} d="M19 3H5c-1.1 0-1.99.9-1.99 2v14c0 1.1.89 2 1.99 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 13H5V8h14v8z"></path></svg> }
    ...
    if (d.type === DocumentType.VIDEO) { return <svg focusable="false" height="24" viewBox="0 0 24 24" width="24" className="aDfHOc vf9sSe NMm5M"><path fill={fill} d="M18 4l2 4h-3l-2-4h-2l2 4h-3l-2-4H8l2 4H7L5 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4h-4z"></path><path d="M0 0h24v24H0z" fill="none"></path></svg> }
    if (d.type === DocumentType.SHORTCUT) { return <svg enableBackground="new 0 0 24 24" focusable="false" height="24" viewBox="0 0 24 24" width="24" className="IQG0lb vf9sSe NMm5M"><g><rect fill="none" height="24" width="24"></rect><path fill={fill} d="M16,2L16,2L16,2H8v2h4.3C9.7,5.81,8,8.81,8,12.2c0,4.83,3.44,8.87,8,9.8v-2.06c-3.44-0.89-6-4.02-6-7.74 c0-2.95,1.61-5.53,4-6.91V10h2L16,2z"></path></g></svg> }
    if (d.type === DocumentType.FOLDER) { return <svg focusable="false" width="24" height="24" viewBox="0 0 24 24" className="IQG0lb vf9sSe NMm5M"><path fill={fill} d="M20 6h-8l-2-2H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm0 12H4V8h16v10z"></path></svg> }
