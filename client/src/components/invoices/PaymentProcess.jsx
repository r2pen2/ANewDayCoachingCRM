...
const StripeLogo = () => <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-credit-card-pay" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
  ...
  return (  
    <Card withBorder radius="md" className="pay-modal-card">
      ...
      <SimpleGrid cols={2} mt="md">
        ...
        <PayButtonV2 method="stripe"  color="#003087"   link={LinkMaster.payments.stripe} />
