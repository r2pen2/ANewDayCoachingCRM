...
import { CurrentUserContext, UserPFPContext } from '../App'
...
export default function Settings() {
  ...
  const {userPFP} = useContext(UserPFPContext)
  ...
  return (
    <div className="d-flex flex-column gap-2 align-items-center justify-content-center">
      ...
      <Avatar src={userPFP} alt={currentUser.displayName} size="xl" style={{marginBottom: "1rem"}} />
